...
import { gamebad, gameend, gamegood, golpeBoss, hitui, yeah } from "src/effects/effects";
...
export class Level3 implements Level {
  ...
  start() {
    ...
    const trigger9 = new Trigger(new Vector3(12, 2, 11.2), gamegood, true);
    const trigger10 = new Trigger(new Vector3(12, 2, 5), gamebad, true);
    });
    // FILE WAS GENERATED BY DCL-EDIT
    // DO NOT MODIFY
