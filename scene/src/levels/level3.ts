...
const finalboss5 = new Entity("finalboss") */
    ...
    if (GlobalVariables.hitLeft) {
      ...
      leftarmhit.getComponent(Transform).scale.setAll(0.5);
      startMove = 0;
    ...
    if (GlobalVariables.hitRight) {
      ...
      rightarmhit.getComponent(Transform).scale.setAll(0.5);
      startMove = 0;
    ...
    if (GlobalVariables.hitMain) {
      ...
      let transform = finalbosshit.getComponent(Transform);
      let distance = Vector3.Forward().scale(dt * 1);
      transform.translate(distance);
      transform = finalboss5.getComponent(Transform);
      distance = Vector3.Forward().scale(dt * -1);
      transform.translate(distance);
    }
  }
